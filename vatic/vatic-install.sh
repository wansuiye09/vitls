...
git clone https://github.com/cvondrick/CITIS.git
...
EOF
    ...
    CITIS extract /home/vagrant/vagrant_data/small.mp4 /home/vagrant/vagrant_data/example/
    CITIS load example_id /home/vagrant/vagrant_data/example/ example_label1 example_label2 example_label3 --offline
