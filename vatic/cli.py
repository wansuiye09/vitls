...
import config
import shutil
from CITIS.cli import handler, importparser, Command, LoadCommand
...
class sample(Command):
    ...
    def __call__(self, args):
        ...
        workers = session.query(CITIS.models.Worker)
        for worker in workers:
            ...
            if since:
                jobs = jobs.filter(CITIS.models.HIT.timeonserver >= since)
...
class find(Command):
    ...
    def __call__(self, args):
        ...
        jobs = jobs.filter(CITIS.models.HIT.useful == True)
